...
function ParagraphBackgroundOverlayBlur() {
  return (
    <div className="absolute backdrop-blur-[0.3px] h-[123px] leading-[0] left-0 not-italic right-0 text-center top-[571px]" data-name="Paragraph+Background+OverlayBlur">
      <div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center left-1/2 text-[32px] text-black top-[17px] translate-x-[-50%] translate-y-[-50%] uppercase w-[409.892px]">
        <p className="css-4hzbpn leading-[33px]">Many of these signals are linked to blood sugar</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center left-1/2 text-[15px] text-[rgba(0,0,0,0.7)] top-[103.5px] translate-x-[-50%] translate-y-[-50%] w-[291.693px]">
        <p className="css-4hzbpn leading-[18px]">But you can control it by knowing sugar spike in advance.</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute inset-0 overflow-auto" data-name="Container">
      ...
      <Button />
      <div className="absolute h-[453.061px] left-1/2 top-[74px] translate-x-[-50%] w-[362.521px]" data-name="4 6">
