...
export function Screen15({ onNext }: Screen15Props) {
  const [selected, setSelected] = useState<string | null>(null);

  const options = [
    { id: 'eat-freely', label: 'I want to eat freely and feel good afterward' },
    { id: 'clarity', label: 'I want clarity instead of guessing' },
    { id: 'eating-out', label: 'I want to feel confident when eating out' },
    { id: 'understand', label: 'I want to understand what works for my body' }
  ];
