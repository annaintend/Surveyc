...
export function Screen10({ onNext }: Screen10Props) {
  ...
  const options = [
    { id: 'mostly-cook', label: 'I mostly cook myself' },
    { id: 'mix', label: 'A mix of home and outside food' },
    { id: 'mostly-outside', label: 'Mostly food I don\'t cook' }
  ];
        ...
        >
          ...
          <div className="mb-6 flex-shrink-0">
            <h1 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[28px] leading-[28.8px] tracking-[0.4px] text-black">
              How much control do you usually have over what you eat?
            </h1>
          </div>
