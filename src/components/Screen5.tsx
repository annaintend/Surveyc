...
export function Screen5({ onNext }: Screen5Props) {
  ...
  const options = [
    { id: 'manage-weight', label: '⚖️ Manage my weight' },
    { id: 'stop-overeating', label: '🚫 Stop overeating' },
    { id: 'feel-better', label: '👍 Feel better after meals' },
    { id: 'smarter-choices', label: '🧠 Make smarter food choices' },
    { id: 'cut-sugar', label: '🍬 Cut down on sugar' }
  ];
