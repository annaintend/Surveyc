...
interface Screen15CProps {
  onNext: (data: Record<string, any>) => void;
}

export function Screen15C({ onNext }: Screen15CProps) {
  const [selected, setSelected] = useState<string | null>(null);

  const options = [
    { id: 'enjoy-not-understand', label: "Something I enjoy but don't fully understand" },
    { id: 'overthink', label: 'Something I overthink' },
    { id: 'affects-energy', label: 'Something that affects my energy more than I expect' },
    { id: 'want-relaxed', label: 'Something I want to feel more relaxed about' }
  ];
      ...
      <div className="h-full flex flex-col max-w-[450px] mx-auto w-full relative">
        ...
        >
          ...
          <div className="mb-6 flex-shrink-0">
            <h1 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[28px] leading-[28.8px] tracking-[0.4px] text-black">
